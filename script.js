...
function createTableRow(row, status, attackLink, index) {
    ...
    return `
    <tr>
        <td class="w-1/5 relative py-4 pl-4 pr-3 text-sm sm:pl-6 min-w-0 ${borderClass}">
            <div class="font-medium text-gray-900 dark:text-gray-300">
        ...
        <td class="w-1/10 relative py-3.5 pl-3 pr-4 text-right text-sm font-medium sm:pr-6 min-w-0 ${borderClass}">${attackLink}</td>
    </tr>
    `;
}
